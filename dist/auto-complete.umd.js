...
var NguiAutoCompleteComponent = /** @class */ (function () {
     ...
     * constructor
     */
    function NguiAutoCompleteComponent(elementRef, autoComplete, zone) {
        var _this = this;
        ...
        this.filterSelected = new core_1.EventEmitter();
        ...
        this.inputElKeyHandler = function (evt) {
            var totalNumItem = _this.filteredList.length + _this.filters.length;
            switch (evt.keyCode) {
                ...
                case 9:// TAB, choose if tab-to-select is enabled
                    if (_this.itemIndex === null || _this.itemIndex === undefined) {
    ...
    NguiAutoCompleteComponent.prototype.reloadList = function (keyword) {
        ...
        if (this.isSrcArr()) {
            this.isLoading = false;
            this.filteredList = this.autoComplete.filter(this.source, keyword, this.matchFormatted, this.ignoreAccents, this.filters);
            if (this.maxNumList) {
            ...
            if (typeof this.source === 'function') {
                ...
                }, function (error) { return null; }, function () { return _this.zone.run(function () { return _this.isLoading = false; }); } // complete
                );
            }
            else {
                // remote source
    ...
    NguiAutoCompleteComponent.prototype.onEnterPressed = function () {
    ...
    NguiAutoCompleteComponent.prototype.onFilterChange = function () {
        return false;
    };
    NguiAutoCompleteComponent.prototype.onFilterClicked = function (filter) {
        this.zone.run(function () { return filter.enabled = !filter.enabled; });
    ...
    __decorate([
        core_1.Input('no-match-found-template'),
        __metadata("design:type", String)
    ], NguiAutoCompleteComponent.prototype, "noMatchFoundTemplate", void 0);
    __decorate([
    ...
    ], NguiAutoCompleteComponent.prototype, "filters", void 0);
    __decorate([
        core_1.Output(),
        __metadata("design:type", Object)
    ...
    __decorate([
        core_1.Output(),
        __metadata("design:type", Object)
    ], NguiAutoCompleteComponent.prototype, "filterSelected", void 0);
    __decorate([
...
var NguiAutoCompleteDirective = /** @class */ (function () {
    function NguiAutoCompleteDirective(resolver, viewContainerRef, parentForm) {
        ...
        this.loadingTemplate = null;
        this.loadingText = 'Loading';
        this.noMatchFoundTemplate = null;
        this.tabToSelect = true;
        this.selectOnBlur = false;
        this.matchFormatted = false;
        this.autoSelectFirstItem = false;
        ...
        this.showAutoCompleteDropdown = function (event) {
            ...
            component.noMatchFoundTemplate = _this.noMatchFoundTemplate;
            ...
            component.filterSelected.subscribe(_this.filterSelected);
            ...
            if (_this.el.tagName !== 'INPUT' && !_this.outerInputElement) {
    ...
    __decorate([
        core_1.Input('outer-input-element'),
        __metadata("design:type", HTMLInputElement)
    ], NguiAutoCompleteDirective.prototype, "outerInputElement", void 0);
    __decorate([
        core_1.Input('autocomplete'),
        __metadata("design:type", Object)
    ...
    __decorate([
        core_1.Input('no-match-found-template'),
        __metadata("design:type", Object)
    ], NguiAutoCompleteDirective.prototype, "noMatchFoundTemplate", void 0);
    __decorate([
    ...
    __decorate([
        core_1.Input('filters'),
        __metadata("design:type", Array)
    ], NguiAutoCompleteDirective.prototype, "filters", void 0);
    __decorate([
        core_1.Input(),
        __metadata("design:type", String)
    ...
    ], NguiAutoCompleteDirective.prototype, "form", void 0);
    __decorate([
    ...
    ], NguiAutoCompleteDirective.prototype, "formControl", void 0);
    __decorate([
        core_1.Input('extFormControl'),
        __metadata("design:type", forms_1.AbstractControl)
...
var NguiAutoComplete = /** @class */ (function () {
    ...
    NguiAutoComplete.prototype.filter = function (list, keyword, matchFormatted, accentInsensitive, filters) {
        var _this = this;
