...
var NguiAutoCompleteDirective = /** @class */ (function () {
    ...
    NguiAutoCompleteDirective.propDecorators = {
        outerInputElement: [{ type: core_1.Input, args: ['outer-input-element',] }],
        ...
        form: [{ type: core_1.Input, args: ['form',] }],
        formControlName: [{ type: core_1.Input, args: ['formControlName',] }],
        formControl: [{ type: core_1.Input, args: ['formControl',] }],
        extFormControl: [{ type: core_1.Input, args: ['extFormControl',] }],
